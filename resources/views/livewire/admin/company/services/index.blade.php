    ...
    <div class="row">
        <div class="col-md-12 p-2">
                    ...
                    @endif
                        ...
                        @include('livewire.admin.company.services.update')
                        @include('livewire.admin.company.services.create')
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                            @if (count($our_serviceses) > 0)
                                @foreach ($our_serviceses as $key=>$about_us)
                                    <tr>
                                        <td>
                                            {{$about_us->title}}
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <button onclick="deleteOurServices({{$about_us->id}})"
