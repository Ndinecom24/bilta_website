    ...
    <div class="container">
        ...
        <div class="section-title">
            ...
            <p data-aos="fade-up">"Welcome to our team! At BiLTA, we are proud to have a diverse and talented
                group of individuals working together to achieve our goals.<br> Our team is made up of passionate professionals who bring a wealth of experience and expertise to the table.</p>
        </div>
...
<style>
    ...
    .toggle-details:checked + label::after {
        content: ' Less'; /* Change button text to 'Less' when checked */
    }

    /* Change appearance of the label (button) */
    .more-btn::after {
        content: ' More'; /* Button text */
    }
</style>
