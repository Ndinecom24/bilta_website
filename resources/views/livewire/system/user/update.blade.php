        ...
        <div class="modal-content">
            ...
            <form>
                <div class="modal-body">
                    <input hidden type="text"  class="form-control" id="exampleFormControlInput3"  wire:model="role_id">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleFormControlInput2" wire:model="slug" placeholder="Enter Description">
