            ...
            <form>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12 col-lg-12 col-sm-12">
                            <div class="form-group">
                                <label for="permissionFormControlInput1">Name</label>
                                <input type="text" class="form-control" id="permissionFormControlInput1"
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12 col-sm-12">
                            <div class="form-group">
                                <label for="permissionFormControlInput2">Description</label>
                                <input type="text" class="form-control" id="permissionFormControlInput2"
                                       wire:model="slug" placeholder="Enter Description">
