...
<section id="topbar" class="d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
        <div class="contact-info d-flex align-items-center">
            <i class="bi bi-envelope d-flex align-items-center"><a href="mailto:contact@example.com">{{$contact_us->email ?? "info@bilta.org"}}</a></i>
            <i class="bi bi-phone d-flex align-items-center ms-4"><span>{{$contact_us->phone ?? "000-000-000"}}</span></i>
        </div>
...
<footer id="footer">
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 footer-links">
                    ...
                    <ul>
                        ...
                        <li><i class="bx bx-chevron-right"></i> <a href="{{route('weekly-prayer-points')}}">Weekly Prayer points</a></li>
                ...
                <div class="col-lg-4 col-md-6 footer-newsletter">
                    ...
                    <p>Get the latest news, weekly prayer points, notifications and exclusive info conveniently in your inbox</p>
    ...
    <div class="container d-lg-flex py-4">
        ...
        <div class="me-lg-auto text-center text-lg-start">
            <div class="copyright">
                &copy; Copyright {{date('Y')}} <strong><span>BILTA</span></strong>. All Rights Reserved
                <p class="fl_right">Designed by <a target="_blank" href="https://www.ndinecom.com" title="This is a bible translation site">Ndinecom</a></p>
        ...
        <div class="social-links text-center text-lg-right pt-3 pt-lg-0">
            <a href="{{$contact_us->twitter_url ?? "#"}}" class="twitter"><i class="bx bxl-twitter"></i></a>
            <a href="{{$contact_us->facebook_url ?? "#"}}" class="facebook"><i class="bx bxl-facebook"></i></a>
            <a href="{{$contact_us->youtube ?? "#"}}" class="-youtube"><i class="bx bxl-youtube"></i></a>
            <a href="{{$contact_us->whatsapp_link ?? "#"}}" class="google-plus"><i class="bx bxl-whatsapp"></i></a>
            <a href="{{$contact_us->linkedin_url ?? "#"}}" class="linkedin"><i class="bx bxl-linkedin"></i></a>
        </div>
    </div>
</footer><!-- End Footer -->
@endif
