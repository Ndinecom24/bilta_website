...
<div>
    ...
    <div class="bgded overlay" style="background-image:url('{{asset('layout/images/demo/backgrounds/01.png')}}')">
        <div id="pageintro" class="hoc clear">
            <!-- ################################################################################################ -->
            <article>
                <h3 class="heading">BiLTA Maintenace Mode</h3>
                <p>Bible Literature Translation Organisations Website Maintenance Page.</p>
                <p>Our Site is being worked on, please check back soon.</p>
                <footer>
                    <span>Our other online presence</span>
